...
export const projectsHome = [
    ...
    {
      title: "QR Generator",
      description: "Kotlin-based Android app with Jetpack Compose for dynamic QR code generation and material design UI.",
      src: "Screenshot (238).png",
      link: "/projects",
      color: "#977F6D"
    },
    {
      ...
      description: "Kotlin Android application offering guided meditation with ExoPlayer integration and offline content storage.",
      src: "Screenshot (239).png",
    ...
    {
      title: "Finalis",
      description: "React/Node.js hospital management system featuring electronic health records and appointment scheduling.",
      src: "Screenshot (239).png",
      link: "https://www.example.com",
      color: "#88A28D"
    },
    {
      title: "Golden Ticket",
      description: "React/Express ticketing platform with real-time updates and automated ticket routing for enterprise support.",
      src: "Mans.jpg",
      link: "https://www.example.com",
      color: "#BBACAF"
    }
