...
const SERVICES = [
  {
    title: "Poster Design",
    description: "Eye-catching poster designs for your events and promotions.",
    id: 1,
    icon: <FiFileText className="carousel-icon" />,
  },
  {
    title: "Website Design",
    description: "Creative and modern website designs tailored to your brand.",
    id: 2,
    icon: <FiLayout className="carousel-icon" />,
  },
  {
    title: "Website Development",
    description: "Custom website development with responsive and interactive features.",
    id: 3,
  ...
  },
  {
    ...
    description: "Seamless integration of APIs to enhance your website functionality.",
    id: 5,
